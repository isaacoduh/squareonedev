...
var _slice = Array.prototype.slice,
    _slicedToArray = (function() {
        function e(e, t) {
            ...
            try {
                for (
                    var a, o = e[Symbol.iterator](); !(n = (a = o.next()).done) &&
                    (i.push(a.value), !t || i.length !== t); n = !0
                );
            } catch (l) {
                (r = !0), (s = l);
            } finally {
...
!(function(e, t) {
            ...
            if (!0 !== e.parsley) {
                ...
                if (
                    ((this._submitSource = null),
                        ...
                        .prop("disabled", !0), !i || null === i.getAttribute("formnovalidate"))
                ) {
    ...
    F.prototype = {
        validate: function(e, t) {
            ...
            return (i = this.validator).validate.apply(
                i, [e].concat(_toConsumableArray(this.requirementList), [t])
            );
        },
    ...
    E.prototype = {
        ...
        needsValidation: function(e) {
            return (
                "undefined" == typeof e && (e = this.getValue()), !(!e.length &&
                    !this._isRequired() &&
            ...
            if ((l || this.refresh(), !o || this._isInGroup(o))) {
                ...
                if (
                    (("undefined" != typeof s && null !== s) ||
                        (s = this.getValue()), !this.needsValidation(s) && !0 !== r)
                )
                    return e.when();
